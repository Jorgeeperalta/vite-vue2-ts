<template>
  <v-container class="home">
    <hello-world msg="Welcome  Vue.js + TypeScript App" />
    <template>
      <v-data-table
        :headers="headers"
        :items="desserts"
    ...
    <v-btn @click="saluda(50)">{{ saludar }}</v-btn>
  </v-container>
</template>
...
export default class Home extends Vue {
  ...
  */
  ...
  saluda(s: number): number {
    this.saludar = this.saludar + s;
    return this.saludar;
  }
